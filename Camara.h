...
public:
	Camara(PV3D* eye, PV3D* look, PV3D* up, GLdouble r,
			GLdouble l, GLdouble t, GLdouble b, GLdouble N,GLdouble F);
	~Camara();

	void setLookAt(PV3D* eye, PV3D* look);
	void setPosEye(PV3D* eye);
